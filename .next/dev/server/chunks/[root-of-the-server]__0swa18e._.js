...
async function GET() {
    try {
        ...
        if (decoded.role === "candidate") {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Candidate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(decoded.id).select("-password");
        } else if (decoded.role === "recruiter") {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Recruiter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(decoded.id).select("-password");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0swa18e._.js.map