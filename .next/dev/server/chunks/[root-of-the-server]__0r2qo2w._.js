...
async function POST(req) {
    try {
        ...
        let user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Candidate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        });
        let role = "candidate";
        if (!user) {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Recruiter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                email
            });
            role = "recruiter";
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0r2qo2w._.js.map